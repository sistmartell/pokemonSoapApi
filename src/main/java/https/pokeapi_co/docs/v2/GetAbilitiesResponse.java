 ...
 *       &lt;sequence>
 *         &lt;element name="abilities" type="{https://pokeapi.co/docs/v2}AbilitiesType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAbilitiesResponse {
    ...
    protected List<AbilitiesType> abilities;
     ...
     * 
     */
    public List<AbilitiesType> getAbilities() {
        if (abilities == null) {
            abilities = new ArrayList<AbilitiesType>();
        }
